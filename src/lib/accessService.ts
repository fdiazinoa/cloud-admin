...
export const permissionCatalog: Array<{ key: CloudAdminPermissionKey; group: string; label: string; description: string }> = [
    ...
    { key: 'improvements_view', group: 'Mejoras', label: 'Consultar', description: 'Ver solicitudes de mejora.' },
    { key: 'improvements_manage', group: 'Mejoras', label: 'Gestionar', description: 'Actualizar y cerrar mejoras.' },
    { key: 'internal_requests_view', group: 'Solicitudes internas', label: 'Consultar', description: 'Ver problemas y solicitudes internas.' },
    { key: 'internal_requests_manage', group: 'Solicitudes internas', label: 'Gestionar', description: 'Crear y actualizar solicitudes.' },
